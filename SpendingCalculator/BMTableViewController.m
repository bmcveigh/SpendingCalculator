...
- (void)viewDidLoad
{
    ...
    NSLog(@"Size of entries array: %lu", (unsigned long)[entriesArray count]);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    cell.textLabel.text = [[entriesArray objectAtIndex:indexPath.row] entry];
    cell.detailTextLabel.text = [[entriesArray objectAtIndex:indexPath.row] budget];
